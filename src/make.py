...
from build_system.io import looping_wait_on
from build_system.projectlib import Project
from build_system.rendering import as_graphviz
...
def get_paths():
    return tuple(glob('*.rst') + glob('build_system/*.py') + glob('*.dot'))
